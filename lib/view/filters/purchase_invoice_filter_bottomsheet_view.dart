...
class PurchaseInvoiceFilterBottomSheetView extends StatelessWidget {
  const PurchaseInvoiceFilterBottomSheetView({super.key});

  @override
  Widget build(BuildContext context) {
    return BaseView<PurchaseInvoiceFilterBottomSheetViewModel>(
  ...
  void applyFilter(PurchaseInvoiceFilterBottomSheetViewModel model,
  ...
  Future _selectToDate(PurchaseInvoiceFilterBottomSheetViewModel model,
      BuildContext context) async {
  ...
  Future _selectFromDate(PurchaseInvoiceFilterBottomSheetViewModel model,
      BuildContext context) async {
    var picked = await showDatePicker(
        context: context,
        initialDate: DateTime.now(),
