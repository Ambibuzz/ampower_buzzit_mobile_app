...
class PurchaseInvoiceDetailViewModel extends BaseViewModel {
    ...
    try {
      if (connectivityStatus == ConnectivityStatus.cellular ||
        ...
        if (response != null) {
          ...
          po = PurchaseInvoice.fromJson(response['docs'][0]);
        ...
        var data =
            locator.get<OfflineStorage>().getItem(Strings.purchaseInvoice);
      ...
      exception(e, cu, 'getPurchaseInvoice');
    } finally {
